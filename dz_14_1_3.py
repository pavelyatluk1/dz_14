# Pavlo Yatluk
# dz_14_1_3
# Додоти до класу Tree 1) метод додавання нових елементів зі списку, 2) методи пошуку мінімального та максимального
# елементів та 3) метод видалення елементів.
